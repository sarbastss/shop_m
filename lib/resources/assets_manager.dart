...
class img {
  ...
  static const String splashbkg = "$imagePath/Background icons.png";
  static const String welcome3 = "$imagePath/Background objects.png"; 
    static const String welcome2 = "$imagePath/Shaped subtraction.png"; 
      static const String welcome1 = "$imagePath/"; 
  static const String onboardingLogo1 = "$imagePath/Find food you love vector.png";
  static const String onboardingLogo2 = "$imagePath/Delivery vector.png";
  static const String onboardingLogo3 = "$imagePath/Live tracking vector.png";
